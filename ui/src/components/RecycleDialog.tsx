...
export function RecycleDialogView({
  ...
  return (
    <Modal title="移入回收站" onClose={onClose} closeDisabled={executing}>
      <div className="modal-body recycle-dialog-body" aria-busy={executing}>
        ...
        {state.phase === "checking" && (
          <p role="status">正在进行安全检查，通过后将直接移入回收站…</p>
        )}
        {executing && (
          <p role="status">
